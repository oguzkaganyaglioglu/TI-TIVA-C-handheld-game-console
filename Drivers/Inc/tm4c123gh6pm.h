 ...
 *  GPIO Register Map
 * */
#define GPIOx_GPIODATA(GPIOx_BASEADDR)           GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x000UL) // GPIO Data
#define GPIOx_GPIODIR(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x400UL) // GPIO Direction
#define GPIOx_GPIOIS(GPIOx_BASEADDR)             GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x404UL) // GPIO Interrupt Sense
#define GPIOx_GPIOIBE(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x408UL) // GPIO Interrupt Both Edges
#define GPIOx_GPIOIEV(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x40CUL) // GPIO Interrupt Event
#define GPIOx_GPIOIM(GPIOx_BASEADDR)             GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x410UL) // GPIO Interrupt Mask
#define GPIOx_GPIORIS(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x414UL) // GPIO Raw Interrupt Status
#define GPIOx_GPIOMIS(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x418UL) // GPIO Masked Interrupt Status
#define GPIOx_GPIOICR(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x41CUL) // GPIO Interrupt Clear
#define GPIOx_GPIOAFSEL(GPIOx_BASEADDR)          GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x420UL) // GPIO Alternate Function Select
#define GPIOx_GPIODR2R(GPIOx_BASEADDR)           GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x500UL) // GPIO 2-mA Drive Select
#define GPIOx_GPIODR4R(GPIOx_BASEADDR)           GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x504UL) // GPIO 4-mA Drive Select
#define GPIOx_GPIODR8R(GPIOx_BASEADDR)           GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x508UL) // GPIO 8-mA Drive Select
#define GPIOx_GPIOODR(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x50CUL) // GPIO Open Drain Select
#define GPIOx_GPIOPUR(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x510UL) // GPIO Pull-Up Select
#define GPIOx_GPIOPDR(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x514UL) // GPIO Pull-Down Select
#define GPIOx_GPIOSLR(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x518UL) // GPIO Slew Rate Control Select
#define GPIOx_GPIODEN(GPIOx_BASEADDR)            GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x51CUL) // GPIO Digital Enable
#define GPIOx_GPIOLOCK(GPIOx_BASEADDR)           GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x520UL) // GPIO Lock
#define GPIOx_GPIOCR(GPIOx_BASEADDR)             GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x524UL) // GPIO Commit
#define GPIOx_GPIOAMSEL(GPIOx_BASEADDR)          GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x528UL) // GPIO Analog Mode Select
#define GPIOx_GPIOPCTL(GPIOx_BASEADDR)           GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x52CUL) // GPIO Port Control
#define GPIOx_GPIOADCCTL(GPIOx_BASEADDR)         GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x530UL) // GPIO ADC Control
#define GPIOx_GPIODMACTL(GPIOx_BASEADDR)         GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0x534UL) // GPIO DMA Control
#define GPIOx_GPIOPeriphID4(GPIOx_BASEADDR)      GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFD0UL) // GPIO Peripheral Identification 4
#define GPIOx_GPIOPeriphID5(GPIOx_BASEADDR)      GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFD4UL) // GPIO Peripheral Identification 5
#define GPIOx_GPIOPeriphID6(GPIOx_BASEADDR)      GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFD8UL) // GPIO Peripheral Identification 6
#define GPIOx_GPIOPeriphID7(GPIOx_BASEADDR)      GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFDCUL) // GPIO Peripheral Identification 7
#define GPIOx_GPIOPeriphID0(GPIOx_BASEADDR)      GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFE0UL) // GPIO Peripheral Identification 0
#define GPIOx_GPIOPeriphID1(GPIOx_BASEADDR)      GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFE4UL) // GPIO Peripheral Identification 1
#define GPIOx_GPIOPeriphID2(GPIOx_BASEADDR)      GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFE8UL) // GPIO Peripheral Identification 2
#define GPIOx_GPIOPeriphID3(GPIOx_BASEADDR)      GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFECUL) // GPIO Peripheral Identification 3
#define GPIOx_GPIOPCellID0(GPIOx_BASEADDR)       GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFF0UL) // GPIO PrimeCell Identification 0
#define GPIOx_GPIOPCellID1(GPIOx_BASEADDR)       GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFF4UL) // GPIO PrimeCell Identification 1
#define GPIOx_GPIOPCellID2(GPIOx_BASEADDR)       GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFF8UL) // GPIO PrimeCell Identification 2
#define GPIOx_GPIOPCellID3(GPIOx_BASEADDR)       GPIOx_ADD_OFFSET(GPIOx_BASEADDR,0xFFCUL) // GPIO PrimeCell Identification 3
